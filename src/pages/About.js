		...
		return (
			<div className="about">
				<div className="about-me">
					...
					<p>I am also a Informatics student at Tallinn University of Technology, where I'm finishing a bachelor's degree.</p>
				</div>
				<div className="social">
					<h4>Find more information about me at:</h4>
					<a target="_blank" href="https://www.linkedin.com/in/indrek-toomsalu/">
						<img src={linkedin} className="social-icon"/>
					</a>
					<a target="_blank" href="https://github.com/Charminz">
